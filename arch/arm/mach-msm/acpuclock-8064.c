...
static struct acpu_level tbl_faster[] __initdata = {
	...
	{ 1, {   972000, HFPLL, 1, 0x24 }, L2(11),  912500 },
	{ 1, {  1026000, HFPLL, 1, 0x26 }, L2(12),  925000 },
	{ 1, {  1080000, HFPLL, 1, 0x28 }, L2(13),  925000 },
	{ 1, {  1134000, HFPLL, 1, 0x2A }, L2(14),  937500 },
	{ 1, {  1188000, HFPLL, 1, 0x2C }, L2(14),  950000 },
	{ 1, {  1242000, HFPLL, 1, 0x2E }, L2(14),  950000 },
	{ 1, {  1296000, HFPLL, 1, 0x30 }, L2(14),  962500 },
	{ 1, {  1350000, HFPLL, 1, 0x32 }, L2(14),  975000 },
	{ 1, {  1404000, HFPLL, 1, 0x34 }, L2(14),  987500 },
...
static struct acpu_level tbl_slow[] __initdata = {
	{ 1, {   384000, PLL_8, 0, 0x00 }, L2(0),   950000 },
	{ 1, {   432000, HFPLL, 2, 0x20 }, L2(1),   962500 },
	{ 1, {   486000, HFPLL, 2, 0x24 }, L2(2),   975000 },
	{ 1, {   540000, HFPLL, 2, 0x28 }, L2(3),   987500 },
	{ 1, {   594000, HFPLL, 1, 0x16 }, L2(4),  1000000 },
	{ 1, {   648000, HFPLL, 1, 0x18 }, L2(5),  1012500 },
	{ 1, {   702000, HFPLL, 1, 0x1A }, L2(6),  1025000 },
	{ 1, {   756000, HFPLL, 1, 0x1C }, L2(7),  1037500 },
	{ 1, {   810000, HFPLL, 1, 0x1E }, L2(8),  1050000 },
	{ 1, {   864000, HFPLL, 1, 0x20 }, L2(9),  1062500 },
	{ 1, {   918000, HFPLL, 1, 0x22 }, L2(10), 1075000 },
	{ 1, {   972000, HFPLL, 1, 0x24 }, L2(11), 1087500 },
	{ 1, {  1026000, HFPLL, 1, 0x26 }, L2(12), 1100000 },
	{ 1, {  1080000, HFPLL, 1, 0x28 }, L2(13), 1112500 },
	{ 1, {  1134000, HFPLL, 1, 0x2A }, L2(14), 1125000 },
	{ 1, {  1188000, HFPLL, 1, 0x2C }, L2(14), 1137500 },
	{ 1, {  1242000, HFPLL, 1, 0x2E }, L2(14), 1150000 },
	{ 1, {  1296000, HFPLL, 1, 0x30 }, L2(14), 1162500 },
	{ 1, {  1350000, HFPLL, 1, 0x32 }, L2(14), 1175000 },
	{ 1, {  1404000, HFPLL, 1, 0x34 }, L2(14), 1187500 },
	{ 1, {  1458000, HFPLL, 1, 0x36 }, L2(14), 1200000 },
	{ 1, {  1512000, HFPLL, 1, 0x38 }, L2(14), 1212500 },
	{ 1, {  1566000, HFPLL, 1, 0x3A }, L2(14), 1225000 },
	{ 1, {  1620000, HFPLL, 1, 0x3C }, L2(14), 1237500 },
...
static struct acpu_level tbl_nom[] __initdata = {
	{ 1, {   384000, PLL_8, 0, 0x00 }, L2(0),   900000 },
	{ 1, {   432000, HFPLL, 2, 0x20 }, L2(1),   912500 },
	{ 1, {   486000, HFPLL, 2, 0x24 }, L2(2),   925000 },
	{ 1, {   540000, HFPLL, 2, 0x28 }, L2(3),   937500 },
...
static struct acpu_level tbl_fast[] __initdata = {
	{ 1, {   384000, PLL_8, 0, 0x00 }, L2(0),   850000 },
	{ 1, {   432000, HFPLL, 2, 0x20 }, L2(1),   862500 },
	{ 1, {   486000, HFPLL, 2, 0x24 }, L2(2),   875000 },
	{ 1, {   540000, HFPLL, 2, 0x28 }, L2(3),   887500 },
	{ 1, {   594000, HFPLL, 1, 0x16 }, L2(4),   900000 },
	{ 1, {   648000, HFPLL, 1, 0x18 }, L2(5),   912500 },
	{ 1, {   702000, HFPLL, 1, 0x1A }, L2(6),   925000 },
	{ 1, {   756000, HFPLL, 1, 0x1C }, L2(7),   937500 },
	{ 1, {   810000, HFPLL, 1, 0x1E }, L2(8),   950000 },
	{ 1, {   864000, HFPLL, 1, 0x20 }, L2(9),   962500 },
	{ 1, {   918000, HFPLL, 1, 0x22 }, L2(10),  975000 },
	{ 1, {   972000, HFPLL, 1, 0x24 }, L2(11),  987500 },
	{ 1, {  1026000, HFPLL, 1, 0x26 }, L2(12), 1000000 },
	{ 1, {  1080000, HFPLL, 1, 0x28 }, L2(13), 1012500 },
	{ 1, {  1134000, HFPLL, 1, 0x2A }, L2(14), 1025000 },
	{ 1, {  1188000, HFPLL, 1, 0x2C }, L2(14), 1037500 },
	{ 1, {  1242000, HFPLL, 1, 0x2E }, L2(14), 1050000 },
	{ 1, {  1296000, HFPLL, 1, 0x30 }, L2(14), 1062500 },
	{ 1, {  1350000, HFPLL, 1, 0x32 }, L2(14), 1087500 },
	{ 1, {  1404000, HFPLL, 1, 0x34 }, L2(14), 1100000 },
	{ 1, {  1458000, HFPLL, 1, 0x36 }, L2(14), 1125000 },
	{ 1, {  1512000, HFPLL, 1, 0x38 }, L2(14), 1137500 },
	{ 1, {  1566000, HFPLL, 1, 0x3A }, L2(14), 1150000 },
	{ 1, {  1620000, HFPLL, 1, 0x3C }, L2(14), 1162500 },
...
static struct acpu_level tbl_faster[] __initdata = {
	...
	{ 1, {  1620000, HFPLL, 1, 0x3C }, L2(14), 1137500 },
